...
def validar(palabras):  # Valida que las palabras cumplan las reglas (verificaciones)
    if(verificacionVerbo(palabras) != True):
      return False
    elif (verificacionVerbo(palabras) or verificacion1(palabras) or verificacion2(palabras) or verificacion3(palabras) or verificacion4(palabras) or verificacion5(palabras) or verificacion6(palabras) or verificacion7(palabras) or verificacion8(palabras)):
        return True
    else:
        return False
